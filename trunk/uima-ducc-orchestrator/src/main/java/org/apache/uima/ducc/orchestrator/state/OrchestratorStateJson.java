...
public class OrchestratorStateJson {
	...
	public OrchestratorStateJson(long sequenceNumberState) {
		setSequenceNumberState(sequenceNumberState);
	}
	
	private void setSequenceNumberState(long value) {
		sequenceNumberState.set(value);
	}
	
	public long getSequenceNumberState() {
		return sequenceNumberState.get();
	}
