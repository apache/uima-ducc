...
public class Workitem extends TOP {
  ...
  public boolean getSendToLast() {
    ...
    return jcasType.ll_cas.ll_getBooleanValue(addr,
            ((Workitem_Type) jcasType).casFeatCode_sendToLast);
  }
  ...
  public boolean getSendToAll() {
    ...
    return jcasType.ll_cas.ll_getBooleanValue(addr,
            ((Workitem_Type) jcasType).casFeatCode_sendToAll);
  }
  ...
  public String getInputspec() {
    ...
    return jcasType.ll_cas.ll_getStringValue(addr,
            ((Workitem_Type) jcasType).casFeatCode_inputspec);
  }
  ...
  public String getOutputspec() {
    ...
    return jcasType.ll_cas.ll_getStringValue(addr,
            ((Workitem_Type) jcasType).casFeatCode_outputspec);
  }
  ...
  /**
   * getter for blockindex - gets Optional parameter to specify block offset into input file to
   * start processing
   * 
   * @generated
   */
  ...
  /**
   * setter for blockindex - sets Optional parameter to specify block offset into input file to
   * start processing
   * 
   * @generated
   */
  ...
  public boolean getLastBlock() {
    ...
    return jcasType.ll_cas.ll_getBooleanValue(addr,
            ((Workitem_Type) jcasType).casFeatCode_lastBlock);
  }
