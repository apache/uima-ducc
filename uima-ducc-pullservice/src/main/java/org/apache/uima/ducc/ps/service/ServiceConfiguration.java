...
public class ServiceConfiguration {
  ...
  public void validateProperties() throws ServiceInitializationException {
    if (analysisEngineDescriptorPath == null) {
      throw new ServiceInitializationException(
              "AE descriptor is missing - unable to launch the service");
    }
    if (threadCount == null) {
      threadCount = "1";
    }
  ...
  public void collectProperties(String[] args) {
    ...
    if (System.getProperty("ducc.process.thread.sleep.time") != null) {
      waitTimeWhenNoTaskGiven = Integer
              .valueOf(System.getProperty("ducc.process.thread.sleep.time"));
    }
    ...
    /*
     * List<String> cmOverrides = getPropertyListString("ducc.deploy.JpCmOverrides"); List<String>
     * aeOverrides = getPropertyListString("ducc.deploy.JpAeOverrides"); List<String> ccOverrides =
