        ...
        \item[Reason Scheduler or extraordinary status] \hfill \\
          ...
          if it is available.
            ...
            \begin{description}          
                ...
                \item[Stopped]	- The process terminated normally. HELP HELP how is this different from Voluntary?
                          
                \item[Voluntary] - The job is winding down, there's no more work for this node, so it stops. 
                  HELP HELP How is this different from Stopped.  Also State Agent has Stopped - does this
