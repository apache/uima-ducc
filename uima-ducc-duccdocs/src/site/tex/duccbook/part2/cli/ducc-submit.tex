...
\end{verbatim}
             ...
             example: 
             \begin{verbatim}
"--process\_environment TERM=xterm DISPLAY=:1.0 DUCC\_LD\_LIBRARY\_PATH=/my/own/path
            \end{verbatim}
...
UIMA-AS:OtherEp:tcp:bluej123:123 
             ...
             See \hyperref[chap:services]{Service Management} for a more detailed discussion
