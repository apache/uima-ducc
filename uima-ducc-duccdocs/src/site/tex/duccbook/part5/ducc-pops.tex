...
\chapter{System Organization}
    ...
    The Logging module facilitates the recording to persistent storage of noteworthy
    events occurring during the \varAgent~lifetime. Noteworthiness is configurable
    as various levels, such as \varINFO, \varDEBUG~and \varTRACE.
    ...
    \begin{itemize}
      ...
      This is the main thread for the \varAgent.  It is responsible for starting, configuring 
      and ending the \varDUCC~framework duties on a \varNodeMachineComputer.
      
      \begin{itemize}
      \item Determine node name, IP address and JMX URL.  Record same to configured state directory,
      utilized by \varWebServer for ease of use display to users/administrators.
      ...
      \item Take down processes for which \varJob~has been de-allocated or ended.
