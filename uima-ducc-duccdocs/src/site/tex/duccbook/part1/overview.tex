\chapter{DUCC Overview}
    ...
    Consumer as shown in \prettyref{fig:UIMA-pipeline}
    ...
    \prettyref{fig:UIMA-AS-pipeline} below.
    ...
    shown in \prettyref{fig:UIMA-AS-pipeline-DUCC} below.
    ...
    of generating one as depicted in \prettyref{fig:UIMA-AS-pipeline-DUCC-DD}
