...
public class Workitem extends TOP {
  ...
  private final static CallSite _FC_sendToLast = TypeSystemImpl.createCallSite(Workitem.class,
          "sendToLast");

  private final static MethodHandle _FH_sendToLast = _FC_sendToLast.dynamicInvoker();

  private final static CallSite _FC_sendToAll = TypeSystemImpl.createCallSite(Workitem.class,
          "sendToAll");

  private final static MethodHandle _FH_sendToAll = _FC_sendToAll.dynamicInvoker();

  private final static CallSite _FC_inputspec = TypeSystemImpl.createCallSite(Workitem.class,
          "inputspec");

  private final static MethodHandle _FH_inputspec = _FC_inputspec.dynamicInvoker();

  private final static CallSite _FC_outputspec = TypeSystemImpl.createCallSite(Workitem.class,
          "outputspec");

  private final static MethodHandle _FH_outputspec = _FC_outputspec.dynamicInvoker();

  private final static CallSite _FC_encoding = TypeSystemImpl.createCallSite(Workitem.class,
          "encoding");

  private final static MethodHandle _FH_encoding = _FC_encoding.dynamicInvoker();

  private final static CallSite _FC_language = TypeSystemImpl.createCallSite(Workitem.class,
          "language");

  private final static MethodHandle _FH_language = _FC_language.dynamicInvoker();

  private final static CallSite _FC_bytelength = TypeSystemImpl.createCallSite(Workitem.class,
          "bytelength");

  private final static MethodHandle _FH_bytelength = _FC_bytelength.dynamicInvoker();

  private final static CallSite _FC_blockindex = TypeSystemImpl.createCallSite(Workitem.class,
          "blockindex");

  private final static MethodHandle _FH_blockindex = _FC_blockindex.dynamicInvoker();

  private final static CallSite _FC_blocksize = TypeSystemImpl.createCallSite(Workitem.class,
          "blocksize");

  private final static MethodHandle _FH_blocksize = _FC_blocksize.dynamicInvoker();

  private final static CallSite _FC_lastBlock = TypeSystemImpl.createCallSite(Workitem.class,
          "lastBlock");
  ...
  public boolean getSendToLast() {
    return _getBooleanValueNc(wrapGetIntCatchException(_FH_sendToLast));
  }
  ...
  public boolean getSendToAll() {
    return _getBooleanValueNc(wrapGetIntCatchException(_FH_sendToAll));
  }
  ...
  public String getInputspec() {
    return _getStringValueNc(wrapGetIntCatchException(_FH_inputspec));
  }
  ...
  public String getOutputspec() {
    return _getStringValueNc(wrapGetIntCatchException(_FH_outputspec));
  }
  ...
  /**
   * getter for encoding - gets Optional parameter to use when converting input files into Java
   * characters
   * 
   * @generated
   * @return value of the feature
  ...
  /**
   * setter for encoding - sets Optional parameter to use when converting input files into Java
   * characters
   * 
   * @generated
   * @param v
  ...
  public int getBytelength() {
    return _getIntValueNc(wrapGetIntCatchException(_FH_bytelength));
  }
  ...
  public int getBlockindex() {
    return _getIntValueNc(wrapGetIntCatchException(_FH_blockindex));
  }
  ...
  public int getBlocksize() {
    return _getIntValueNc(wrapGetIntCatchException(_FH_blocksize));
  }
  ...
  public boolean getLastBlock() {
    return _getBooleanValueNc(wrapGetIntCatchException(_FH_lastBlock));
  }
