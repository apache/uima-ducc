    ...
    extends AServicePing
{
    ...
    double goal = 2.00;                  // want to get enqueue time towith this factor of individual service time
        ...
        throws Exception
    {
        ...
        if ( args != null ) {
            ...
            this.log_enabled = props.getBooleanProperty("enable-log", this.log_enabled);
    ...
    void calculateNewDeployment(IServiceStatistics stats)
    {
        ...
        if ( Q == 0 ) {
            ...
            doLog(methodName, "eT", eT, "Q", Q, "cc", cc, "Ti", Ti, "Tt", Tt, "g", g, "r", r, "active", active, "ninstances", ninst, "max_instances", max_instances);
