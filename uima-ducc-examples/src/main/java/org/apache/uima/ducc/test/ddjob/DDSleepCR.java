...
public class DDSleepCR extends CollectionReader_ImplBase {
    ...
    //private volatile int n_work_items = 4;
    ...
    PrintStream jdmark;
        ...
        String n_wi = ((String) getConfigParameterValue("n_work_items"));
        logger.log(Level.INFO, " ****** BB error_rate " + n_wi);
        //n_work_items = Integer.parseInt(n_wi);
        ...
        //work_items_remaining = workitems.size();
    ...
    public synchronized void getNext(CAS cas) throws IOException, CollectionException 
    {
        ...
        //int nwi = Math.max(n_work_items, work_items_remaining);
