...
public class JobFactoryV1 implements IJobFactory {
	private static JobFactoryV1 jobFactory = new JobFactoryV1();
	private static final DuccLogger logger = DuccLoggerComponents.getOrLogger(JobFactoryV1.class.getName());
