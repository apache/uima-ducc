...
<body onload="ducc_init('services-deployments');">
...
<input type="image" onClick="ducc_refresh('services-deployments')" title="Refresh" alt="Refresh" src="opensources/images/1284662827_refresh.png">
</div>
<br>
<table>
<tr>
...
<!-- *********************** column ************************ -->
<td valign="middle" align="center">
<h2><span class="subtitle">Services Deployments</span></h2>
<img src="opensources/images/90px-Swimming_white_domesticated_ducks.jpg" style="border:3px solid #ffff7a" alt="logo">
</td>
<!-- *********************** column ************************ -->
<td valign="middle" align="center">
<table>
...
<td valign="middle" align="center" colspan="5">
        ...
        <td>
			...
			<th title="The time this  was finished">End</th>
			<th title="The user who submitted this ">User</th>
			<th title="The user specified class of this ">Class</th>
			<th title="The current state of this ">State</th>
			<th title="The reason for the final state of this , normally EndOfJob">Reason</th>
