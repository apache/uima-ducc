...
<body onload="ducc_init('system-classes');">
...
<input type="image" onClick="ducc_refresh('system-classes')" title="Refresh" alt="Refresh" src="opensources/images/1284662827_refresh.png">
</div>
<br>
<table>
<tr>
...
<!-- *********************** column ************************ -->
<td valign="middle" align="center">
<h2><span class="subtitle">System Classes</span></h2>
<img src="opensources/images/Flying_mallard_duck_-_female_2.0x1.4.jpg" style="border:3px solid #ffff7a" alt="logo">
</td>
<!-- *********************** column ************************ -->
<td valign="middle" align="center">
<table>
