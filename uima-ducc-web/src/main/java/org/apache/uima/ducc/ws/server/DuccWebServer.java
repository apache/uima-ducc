...
public class DuccWebServer {
  ...
  public enum ConfigValue {
    MaxThreads("500"), IdleTimeout("30000"), PortHttp("42133"), PortHttps("42155"), WelcomePage("index.html"), JavaVersion("1.8");
   ...
   * 
   * 1. use 'keytool -keystore keystore -alias jetty -genkey -keyalg RSA -validity 10000' to create keystore in ducc_web/etc directory 2. in
   * ducc.properties set SSL port, for example: ducc.ws.port.ssl = 42155
   */
  ...
  /**
   * The DUCC cluster name can be set in the ducc.properties file, for example: ducc.cluster.name=Watson!
   */
  ...
  /**
   * The DUCC class definition file can be set in the ducc.properties file, for example: ducc.rm.class.definitions = blade.classes
   */
